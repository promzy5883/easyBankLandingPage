...
export default function SocialIcons() {
  const [socialIconsColor, setSocialIconsColor] = useState({
    faceBookFill: "#FFF",
    youtubeFill: "#FFF",
    twitterFill: "#FFF",
    pinterestFill: "#FFF",
  ...
  const faceBook = (
    <a
      href="#"
      onMouseOver={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, faceBookFill: "hsl(136, 65%, 51%)" };
        })
      }
      onMouseOut={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, faceBookFill: "#FFF" };
        })
      }
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
        <path
          fill={`${socialIconsColor.faceBookFill}`}
  ...
  const youtube = (
    <a
      ...
      onMouseOver={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, youtubeFill: "hsl(136, 65%, 51%)" };
        })
      }
      onMouseOut={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, youtubeFill: "#FFF" };
        })
      }
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
        <path
          fill={`${socialIconsColor.youtubeFill}`}
  ...
  const twitter = (
    <a
      ...
      onMouseOver={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, twitterFill: "hsl(136, 65%, 51%)" };
        })
      }
      onMouseOut={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, twitterFill: "#FFF" };
        })
      }
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="21" height="18">
        <path
          fill={`${socialIconsColor.twitterFill}`}
  ...
  const pinterest = (
    <a
      ...
      onMouseOver={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, pinterestFill: "hsl(136, 65%, 51%)" };
        })
      }
      onMouseOut={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, pinterestFill: "#FFF" };
        })
      }
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
        <path
          fill={`${socialIconsColor.pinterestFill}`}
  ...
  const instagram = (
    <a
      ...
      onMouseOver={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, instagramFill: "hsl(136, 65%, 51%)" };
        })
      }
      onMouseOut={() =>
        setSocialIconsColor((prev) => {
          return { ...prev, instagramFill: "#FFF" };
        })
      }
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
        <path
          fill={`${socialIconsColor.instagramFill}`}
  ...
  return { faceBook, youtube, twitter, pinterest, instagram };
}
